...
class ConvAutoencoder(nn.Module):
    def __init__(self):
        ...
        #Encoder
        #было  self.conv1 = nn.Conv2d(3, 16, 3, padding=1)
        # self.conv2 = nn.Conv2d(16, 4, 3, padding=1)
        self.conv1 = nn.Conv2d(3, 16, 5, padding=2) # filter 5 x 5
        self.conv2 = nn.Conv2d(16, 4, 5, padding=2)
...
#Epochs
n_epochs = 150 #добавила 20 эпох к имеющим 100
